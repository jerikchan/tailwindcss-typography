            ...
            <div className="space-y-10 sm:space-y-0 sm:flex sm:items-center sm:justify-between">
              ...
              <div>
                <a
                  ...
                  className="inline-flex items-center px-3 py-2 space-x-2 text-sm font-medium leading-5 text-gray-300 transition duration-100 ease-in-out bg-gray-800 rounded-md shadow-lg hover:bg-gray-700 dark:text-gray-200 dark:bg-gray-700 dark:hover:bg-gray-600"
                >
